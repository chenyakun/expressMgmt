...
ALTER PACKAGE emp_action_pkg COMPILE SPECIFICATION;  --编译包规范
 ...
 /* Formatted on 2011/10/18 06:46 (Formatter Plus v4.8.8) */
SELECT   line, text
    FROM user_source
...
/* Formatted on 2011/10/18 14:31 (Formatter Plus v4.8.8) */
...
/* Formatted on 2011/10/19 09:35 (Formatter Plus v4.8.8) */
...
/* Formatted on 2011/10/19 10:29 (Formatter Plus v4.8.8) */
...
/* Formatted on 2011/10/20 11:03 (Formatter Plus v4.8.8) */
DECLARE
...
/* Formatted on 2011/10/20 12:15 (Formatter Plus v4.8.8) */
DECLARE
   v_jobno   NUMBER;
BEGIN
   DBMS_JOB.submit
...
/* Formatted on 2011/10/20 16:10 (Formatter Plus v4.8.8) */
SELECT job, next_date, next_sec, INTERVAL, what
  FROM user_jobs
 WHERE job = 22904
 
 
/* Formatted on 2011/10/21 10:03 (Formatter Plus v4.8.8) */
