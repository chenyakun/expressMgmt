...
import sy.model.Branch;
import sy.model.Customer;
import sy.model.Employee;
import sy.model.Goods;
import sy.model.InterAera;
...
public class RepairServiceImpl implements RepairServiceI {
	...
	private BaseDaoI<Branch> branchDao;
	private BaseDaoI<Customer> customerDao;
	private BaseDaoI<Employee> employeeDao;
	private BaseDaoI<expUserEmp> expUserEmpDao;
	private BaseDaoI<Goods> goodsDao;
	private BaseDaoI<InterAera> interAreaDao;
...
//		TODO: branch
	...
	public BaseDaoI<Customer> getCustomerDao() {
		return customerDao;
	}
	@Autowired
	public void setCustomerDao(BaseDaoI<Customer> customerDao) {
		this.customerDao = customerDao;
	}

	public BaseDaoI<Employee> getEmployeeDao() {
		return employeeDao;
	}
	@Autowired
	public void setEmployeeDao(BaseDaoI<Employee> employeeDao) {
		this.employeeDao = employeeDao;
	}

	public BaseDaoI<expUserEmp> getExpUserEmpDao() {
		return expUserEmpDao;
	}
	@Autowired
	public void setExpUserEmpDao(BaseDaoI<expUserEmp> expUserEmpDao) {
		this.expUserEmpDao = expUserEmpDao;
	}
	...
	public BaseDaoI<InterAera> getInterAreaDao() {
		return interAreaDao;
	}
	@Autowired
	public void setInterAreaDao(BaseDaoI<InterAera> interAreaDao) {
		this.interAreaDao = interAreaDao;
	}
